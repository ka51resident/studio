...
export const metadata: Metadata = {
  ...
  description:
    "Explore career opportunities at Akash Enterprises. Join our team and help us power the future with innovative and sustainable electrical solutions.",
};
...
const jobOpenings = [
  {
    ...
    summary:
      "Responsible for planning, executing, and completing electrical projects safely, on time, and as per contract requirements.",
    responsibilities: [
  ...
  // },
  {
    ...
    experience: "1 to 3 years",
    summary:
      "Supports administrative and coordination work at site and office.",
    responsibilities: [
    ...
    <div className="container py-12 md:py-24 animate-in fade-in duration-500">
      <section className="text-center mb-12">
        ...
        <p className="max-w-3xl mx-auto text-muted-foreground text-lg text-center animate-in fade-in slide-in-from-top-6 duration-700">
          Join our team and be a part of a legacy of excellence in the
          electrical engineering industry. We are looking for passionate,
          skilled, and dedicated individuals to help us power the future.
        </p>
        <p className="mt-4 font-semibold text-primary">
          OPEN ROLES AS ON 9th April 2026
        </p>
      </section>
